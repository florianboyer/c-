...
void Application::ajouterPersonne()
{
	...
	Personne personneAAjouter;
	//on fait saisir ses informations
	personneAAjouter.saisir();
	//on l'ajoute au vecteur de personne
	vectPersonne.push_back(personneAAjouter);
}
